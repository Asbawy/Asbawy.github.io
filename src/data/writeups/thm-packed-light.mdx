  ...
  steps={[
    ...
    },
    {
      ...
      output: [
        ...
        {
          text: "[!] Cryptanalysis: sendltr() encrypts characters individually.",
          color: "magenta",
        },
        {
          text: "[!] Because len(data) == 1, index i=0 always -> XOR byte is key[0] ('H', 0x48)",
          color: "magenta",
        },
      ],
      delayAfter: 800,
    },
    {
      ...
      output: [
        {
          text: "[*] Step 3/4: Harvesting exfiltrated 'hotel_sess_state' cookies...",
          color: "blue",
        },
