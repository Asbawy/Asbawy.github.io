...
<Callout type="info">
  We talk about this technique, PATH hijacking, and Linux sudo escalation vectors in depth in our blog & cheatsheet: [Linux Privilege Escalation: Basics & Exploitation](/cheatsheet/linux/privesc-exploitation) and [Linux Privilege Escalation: Enumeration & Recon](/cheatsheet/linux/privesc-enumeration).
</Callout>
