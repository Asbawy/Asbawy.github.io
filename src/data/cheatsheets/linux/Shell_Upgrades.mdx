...
- [The Modern Way: Penelope (Recommended)](#the-modern-way-penelope-recommended)
  - [Installation](#installation)
  - [Basic Usage](#basic-usage)
  - [Key Features](#key-features)
  - [Penelope Session Commands](#penelope-session-commands)
- [🛠️ Manual Upgrade Methods](#manual-upgrade-methods)
  - [Method 1: Python PTY (Most Common)](#method-1-python-pty-most-common)
  - [Method 2: Script Command ](#method-2-script-command)
  - [Method 3: Socat ](#method-3-socat)
  - [Method 4: Using stty/nc (No Python)](#method-4-using-stty-nc-no-python)
- [The Full Interactive TTY Upgrade](#the-full-interactive-tty-upgrade)
  - [Step-by-Step](#step-by-step)
  - [Quick Version (If You Know Your Terminal Size)](#quick-version-if-you-know-your-terminal-size)
- [Alternative Languages & Tools](#alternative-languages-tools)
  - [Perl](#perl)
  - [Ruby](#ruby)
  - [Lua](#lua)
  - [AWK](#awk)
  - [Using /bin/sh (Minimal)](#using-bin-sh-minimal)
- [Terminal Size Reference](#terminal-size-reference)
- [🔗 Resources](#resources)
