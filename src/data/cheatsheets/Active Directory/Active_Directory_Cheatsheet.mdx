...
<Callout type="warning">
  **OpSec:** Kerberos enumeration (Kerbrute) generates Event 4768 but avoids lockout. SMB NULL
  session attempts generate Event 4625. Check password policy first to avoid lockouts.
</Callout>
...
_Bypass EDR trigger: Use `net1` instead of `net`._
...
_Requires full compromise of the child domain (KRBTGT hash)._
