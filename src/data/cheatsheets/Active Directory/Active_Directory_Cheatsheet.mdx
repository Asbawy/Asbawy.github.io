...
- [1. ACL Abuse](#1-acl-abuse)
  - [1.1 GenericAll](#11-genericall)
  - [1.2 GenericWrite](#12-genericwrite)
  - [1.3 WriteDacl](#13-writedacl)
  - [1.4 WriteOwner](#14-writeowner)
  - [1.5 Self (AddSelf)](#15-self-addself)
  - [1.6 AllExtendedRights](#16-allextendedrights)
- [2. Kerberos Attacks](#2-kerberos-attacks)
  - [2.1 AS-REP Roasting](#21-as-rep-roasting)
  - [2.2 Kerberoasting](#22-kerberoasting)
- [3. Delegation Abuse](#3-delegation-abuse)
  - [3.1 Unconstrained Delegation](#31-unconstrained-delegation)
  - [3.2 Constrained Delegation](#32-constrained-delegation)
  - [3.3 Resource-Based Constrained Delegation (RBCD)](#33-resource-based-constrained-delegation-rbcd)
- [4. Domain Dominance](#4-domain-dominance)
  - [4.1 DCSync](#41-dcsync)
  - [4.2 Golden Ticket](#42-golden-ticket)
  - [4.3 Silver Ticket](#43-silver-ticket)
- [5. GPO Abuse](#5-gpo-abuse)
- [6. ADCS — ESC1 through ESC8](#6-adcs--esc1-through-esc8)
- [Quick Reference: Attack Path Decision Matrix](#quick-reference-attack-path-decision-matrix)
