...
<div className="my-6 p-4 border-l-4 border-red-500 bg-red-500/10 rounded-r flex flex-col gap-2">
  ...
  <p className="m-0 text-sm text-foreground/80">
    Sanitizers fail <strong>all the time</strong>. Developers often use flawed regex, create
    blacklists that miss edge cases, or assume stripping HTML tags stops all attacks.{" "}
    <strong>Never trust sanitization alone.</strong>
  </p>
</div>
