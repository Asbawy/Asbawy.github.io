...
readTime: "12 min"
url: "https://asbawy.github.io/logs/badsuccessor"
---
...
<Callout type="danger">
  **The Core Flaw:** The operation that initiates migration is restricted to Domain Admins. The
  attributes that encode migration state are not. The KDC trusts these attributes unconditionally,
  with no verification of the process by which they were written. This is the gap BadSuccessor
  exploits.
</Callout>
