      ...
      <div className="p-5">
        <div className="flex items-start gap-4">
          ...
          <Link to="/about" className="shrink-0 group">
            <div className="relative rounded-full bg-foreground/5 p-1 border border-foreground/30 shadow-[0_0_10px_rgba(0,255,136,0.1)] hover:border-foreground/45 hover:shadow-[0_0_15px_rgba(0,255,136,0.2)] transition-all duration-300 backdrop-blur-md overflow-hidden">
              {/* Soft glowing backdrop to illuminate the dark logo */}
              <div className="absolute inset-1 rounded-full bg-foreground/20 blur-md pointer-events-none" />
              <img
                src="/eye-of-ra.png"
                alt="Eye of Ra"
          ...
          <div className="min-w-0 flex-1">
            <Link
              to="/about"
              className="font-mono text-sm text-foreground hover:text-foreground transition-colors"
            >
              Asbawy
